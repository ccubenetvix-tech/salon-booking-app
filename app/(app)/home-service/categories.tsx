...
export default function HomeServiceCategoriesScreen() {
  ...
  const handleContinue = () => {
    if (selectedCategories.length > 0) {
      router.push({
        pathname: '/(app)/home-service/address' as any,
  ...
  return (
    <View style={styles.container}>
      <Header title="At-Home Services" />
      <View style={styles.subtitleContainer}>
        <Text style={styles.subtitle}>Select services you want at home</Text>
      </View>
